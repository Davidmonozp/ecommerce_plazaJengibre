            ...
            <div class="bg-gray-800 mx-auto max-w-6xl mt-12">
                ...
                <div class="mx-12 p-3 rounded-xl shadow-sm bg-gray-900">
                    <div class="p-3 mx-6 border-b border-gray-500">
                        <input name="nombre" placeholder="Nombre de la Categoria" class="bg-transparent text-yellow-500 w-full focus:outline-none focus:rang" type="text" required />
                    </div>
                    <div class="p-3 mx-6 border-b border-gray-500">
                        <input name="descripcion" placeholder="Descripción de la categoria" class="bg-transparent text-yellow-500 w-full focus:outline-none focus:rang" type="text" required />
                    </div>                                  
                </div>
